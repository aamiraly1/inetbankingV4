...
public class SFTESTING {
	...
	void Test_ifSFEXIST() throws SQLException
	{
		...
		AssertJUnit.assertEquals(rs1.getString("Name"),"CustomerLevel");
	...
	void Test_customerlvl() throws SQLException
	{
		...
		AssertJUnit.assertEquals(compareresult(rs1,rs2),false);
	...
	void test_cuslevel() throws SQLException
	{
		...
		AssertJUnit.assertEquals(cuslvl, exp_cuslvl);
	}
